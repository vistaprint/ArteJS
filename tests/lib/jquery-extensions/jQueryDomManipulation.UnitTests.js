...
var wrapWithBlockTestData = [
        {
            ...
            options : { tagName: $.Arte.constants.tagName.DIV, styleName: "text-align", styleValue: "left" },
        ...
        },
        {
            ...
            options: { applierTagName: $.Arte.constants.tagName.DIV, styleName: "text-align", styleValue: "left" },
            evaluateResult: function(result)
            {
                var style = $("<div/>").css("text-align", "left").attr("style");
        ...
        },
        {
            name: "wrapWithLi",
            rawContent: sampleContent.join(''),
            options: { applierTagName: $.Arte.constants.tagName.LI, styleName: "text-align", styleValue: "left" },
            targetElement: function()
            {
...
var unwrapBlockTestData = [
        {
            ...
            options: { styleName: "text-align", styleValue: "left" },
            evaluateResult: function (result)
            {
        ...
        },
        {
            ...
            options: { commandName: "textAlign", styleName: "text-align" },
            evaluateResult: function (result)
            {
        ...
        var wrapWithOptionsTestData = [
    {
        ...
        rawContent: sampleContent.join(''),
        elementId: "span",
        options: { applierTagName: "span", styleName: "font-weight", styleValue: "bold" },
        evaluateResult: function(result)
        {
    ...
    },
        {
            ...
            rawContent: sampleContent.join(''),
            elementId: "span",
            options: { applierTagName: "div", styleName: "font-weight", styleValue: "bold" },
            evaluateResult: function(result)
            {
                var styles = $.Arte.dom.getStyles(result);
...
var createContainerTestData = [
        {
            ...
            operation: function ()
            {
                return $.Arte.dom.createContainer({ applierTagName: "span" });
            },
            evaluateResult: function (result)
            {
        ...
        },
        {
            ...
            operation: function ()
            {
                return $.Arte.dom.createContainer({ applierTagName: "span", styleName: "font-weight", styleValue: "bold" });
            },
            evaluateResult: function (result)
            {
                var styles = $.Arte.dom.getStyles(result);
        ...
        },
        {
            ...
            operation: function ()
            {
                return $.Arte.dom.createContainer({ applierTagName: "div", className: "arte-font-weight-bold" });
            },
            evaluateResult: function (result)
            {
        ...
        },
        {
            ...
            operation: function ()
            {
                return $.Arte.dom.createContainer({ applierTagName: "div", className: "arte-font-weight-bold", styleName: "font-weight", styleValue: "bold" });
            },
            evaluateResult: function (result)
            {
                var styles = $.Arte.dom.getStyles(result);
        ...
        },
        {
            ...
            operation: function ()
            {
                return $.Arte.dom.createContainer({ applierTagName: "div", attr: { "class": "arte-font-weight-bold"} });
            },
            evaluateResult: function (result)
            {
                return result.is("div") && result.hasClass("arte-font-weight-bold");
