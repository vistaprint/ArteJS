...
var prevSiblingIncludingTextNodesTestData = [
    ...
    },
    {
        ...
        op: function(jElement)
        {
            var noEmptyTextNodesFilter = function(index, element) { return !(element.nodeType === 3 && element.nodeValue.match(/^\s*$/ig)); };
...
var closestWithCommandTestData = [
    {
        ...
        evaluateResult: function(result)
        {
         ...
         },
         {
             ...
             options: { className: "arte-font-color-red" },
             evaluateResult: function(result)
             {
                 return result.length === 0;
             }
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "spanWithParentDivAndSibling",
             options: { className: "arte-font-color-black" },
             evaluateResult: function(result)
             {
                 return result.length === 1 && result.hasClass("arte-font-color-red");
             }
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "spanWithParentDivAndSibling",
             options: { className: "arte-font-style-italic" },
             evaluateResult: function(result)
             {
                 return result.length === 1 && result.hasClass("arte-font-style-italic");
             }
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "spanWithParentDivAndSibling",
             options: { className: "arte-font-size-15" },
             evaluateResult: function(result)
             {
...
var closestWithCommandValueTestData = [
    {
        ...
        evaluateResult: function(result)
        {
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "firstSpan",
             options: { styleName: "font-family", styleValue: "arial" },
             evaluateResult: function(result)
             {
                 var styles = $.Arte.dom.getStyles(result);
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "firstSpan",
             options: { styleName: "color", styleValue: "black" },
             evaluateResult: function(result)
             {
                 var styles = $.Arte.dom.getStyles(result);
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "firstSpan",
             options: { styleName: "color", styleValue: "red" },
             evaluateResult: function(result)
             {
                 return result.length === 0;
             }
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "spanWithParentDivAndSibling",
             options: { styleName: "font-style", styleValue: "italic" },
             evaluateResult: function(result)
             {
                 return result.length === 0;
             }
         ...
         },
         {
             ...
             rawContent: sampleContent.join(''),
             elementId: "spanWithParentDivAndSibling",
             options: { className: "arte-font-size-10" },
             evaluateResult: function(result)
             {
                 return result.length === 1 && result.hasClass("arte-font-size-10");
             }
...
var hasClassWithPatternTestData = [
        {
            ...
            options: { command: $.Arte.configuration.commands.bold },
            evaluateResult: function(result)
            {
                return !result;
            }
    ...
    },
    {
        ...
        rawContent: sampleContent.join(''),
        elementId: 'divWithP',
        options: { command: $.Arte.configuration.commands.italic },
        evaluateResult: function(result)
        {
            return result;
        }
    },
    {
        ...
        rawContent: sampleContent.join(''),
        elementId: 'divWithSpan',
        options: { command: $.Arte.configuration.commands.fontSize },
        evaluateResult: function(result)
        {
            return result;
        }
...
var allHaveClassTestData = [
    {
        ...
        },
        {
            ...
            rawContent: sampleContent.join(''),
            elementId: 'divWithP',
            options: { className: "arte-font-style-x" },
            evaluateResult: function(result)
            {
                return !result;
            }
...
var hasSameStylesTestData = [
        ...
        },
        {
            ...
            rawContent: sampleContent.join(''),
            elementId: 'divWithP',
            options: { otherElement: "#divWithSpans" },
            evaluateResult: function(result)
            {
                return !result;
            }
